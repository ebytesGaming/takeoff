const {
  ...
  module.exports = {
    ...
    async execute(message) {
      ...
      const Text = new TextDisplayBuilder().setContent('TAKEOFF — Where Your Ideas Leave the Ground. At TAKEOFF, we dont just dream — we launch. Whatever you imagine, we make it real. Explore our designers creations in the portfolios channel and see whats possible. Ready to lift off? Place your order to orbit!')
