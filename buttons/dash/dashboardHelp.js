    ...
    async execute(interaction) {
      try {
        ...
        const modal = new ModalBuilder()
          ...
          .setTitle('Dashboard Assistance Request'); // FIXED: Added a descriptive title

        const questionInput = new TextInputBuilder()
          .setCustomId('dashboardInquiryReason')
          .setLabel('What do you need help with?')
          .setStyle(TextInputStyle.Paragraph)
          .setPlaceholder('Describe your issue or question regarding the dashboard here.') // FIXED: Added a helpful placeholder
          .setRequired(true);
